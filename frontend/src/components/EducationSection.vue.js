...
if (__VLS_ctx.items.length) {
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.items))) {
        ...
        (__VLS_ctx.EDUCATION_LEVEL_LABELS[item.level]);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "p-2" },
        });
        (item.start_date ?? '—');
...
if (__VLS_ctx.showForm) {
    ...
    (__VLS_ctx.form.institution_name);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({
        ...{ class: "mb-1 block text-xs text-slate-600" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
        value: __VLS_ctx.form.level,
        ...{ class: "w-full rounded border px-2 py-1.5 text-sm" },
    });
    for (const [label, value] of __VLS_getVForSourceType((__VLS_ctx.EDUCATION_LEVEL_LABELS))) {
    ...
    (__VLS_ctx.form.document_number);
    if (__VLS_ctx.error) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
