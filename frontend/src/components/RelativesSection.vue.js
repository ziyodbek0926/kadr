...
if (__VLS_ctx.items.length) {
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.items))) {
        ...
        (__VLS_ctx.RELATIVE_TYPE_LABELS[item.relation_type]);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "p-2" },
        });
        (item.full_name);
        ...
        ([item.workplace, item.position_title].filter(Boolean).join(', ') || '—');
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
            ...{ class: "p-2" },
        });
        (item.address ?? '—');
...
if (__VLS_ctx.showForm) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
        value: __VLS_ctx.form.relation_type,
        ...{ class: "w-full rounded border px-2 py-1.5 text-sm" },
    });
    for (const [label, value] of __VLS_getVForSourceType((__VLS_ctx.RELATIVE_TYPE_LABELS))) {
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            RELATIVE_TYPE_LABELS: RELATIVE_TYPE_LABELS,
            showForm: showForm,
            form: form,
            saving: saving,
            error: error,
